        ...
        <div class="login-main add-list posr">
         ...
         <div class="log log-1">
          <div class="login">
            ...
            <form name="classifieds_form" id="classifieds_form" method="post" action="<?= base_url('user/add-classifieds') ?>" enctype="multipart/form-data">
              <ul>
                <li>
                  <!--FILED START-->
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="featured_classifieds">Classifieds Title</label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="featured_classifieds">Select Category</label>
