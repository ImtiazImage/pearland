				...
				<ul id="intseres">
					<li>
						<div class="pro-eve-box">
							<div>
								<img src="<?= base_url() ?>/assets/images/blogs/blog1.jpeg" alt="">
							</div>
							<div>
								<p>10, Dec 2019</p>
                    ...
                    <li>
						<div class="pro-eve-box">
							<div>
								<img src="<?= base_url() ?>/assets/images/blogs/blog3.jpg" alt="">
							</div>
							<div>
								<p>10, Dec 2019</p>
								<h2>Source and URL tracking</h2>
                    ...
                    <li>
						<div class="pro-eve-box">
							<div>
								<img src="<?= base_url() ?>/assets/images/blogs/blog4.jpg" alt="">
							</div>
							<div>
								<p>10, Dec 2019</p>
								<h2>Source and URL tracking</h2>
                    ...
                    <li>
						<div class="pro-eve-box">
							<div>
								<img src="<?= base_url() ?>/assets/images/blogs/blog5.jpg" alt="">
							</div>
							<div>
								<p>10, Dec 2019</p>
								<h2>Source and URL tracking</h2>
