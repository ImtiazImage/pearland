...
<body data-new-gr-c-s-check-loaded="14.1004.0" data-gr-ext-installed="" style="overflow: visible;">
	<!-- Preloader -->
									...
									<div class="mob-me-all">
										...
										<div class="mv-cate">
											...
											<ul>
												...
												<li> <a href="all-listing/hotel-&amp;-food">Hotel &amp; Food</a>
												</li>
			...
			<div class="row">
				<div class="add-list-ste">
					<div class="add-list-ste-inn">
						<ul>
							<li>
								<a href="add-listing-step-1"> <span>Step 1</span>
									<b>Basic Info</b>
								</a>
							</li>
							<li>
								<a href="add-listing-step-2" class="act"> <span>Step 2</span>
									<b>Services</b>
								</a>
							</li>
							<li>
...
" required="required" class="validate">
								...
								<div class="row">
									...
									<div class="col-md-12"> <a href="add-listing-step-3" class="skip">Skip this                                        &gt;&gt;</a>
									</div>
								</div>
								<!--FILED END-->
							</form>
