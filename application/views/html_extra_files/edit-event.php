...
<body>
									...
									<div class="container">
										<div class="row"> <i class="material-icons clopme">close</i>
											...
											<div class="pmenu-cat">
												...
												<ul id="pg-resu">
													<li><a href="all-listing.html">Wedding halls - <span>04</span></a>
													</li>
								...
								<ul>
									<li>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" name="event_name" required="required" class="form-control" value="CHAMPIONS OF INDIA RUN-RIDE-WALK" placeholder="Event Name*">
												</div>
											</div>
										</div>
										<!--FILED END-->
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" name="event_address" required="required" class="form-control" value="chennai" placeholder="Address*">
												</div>
											</div>
										</div>
										<!--FILED END-->
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" id="event_start_date" name="event_start_date" required="required" class="form-control" value="03/21/2021" placeholder="Date*">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" name="event_time" required="required" class="form-control" value="5:00 pm" placeholder="Time*">
												</div>
											</div>
										</div>
										<!--FILED END-->
											...
											<div class="col-md-12">
												<div class="form-group">
													<textarea class="form-control" required="required" name="event_description" id="event_description" placeholder="Event Details">
														<p>Yes! you are a champion if you are still following your new year fitness goals.&nbsp;</p>
														<p>Join this virtual run-ride-walk to achieve your resolution of becoming more fit than ever this year.&nbsp;</p>
														<p>Date: 21 March - 07 April 2021</p>
														<p><strong>#RunRideLikeAChampion</strong>
														</p>
													</textarea>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" name="event_contact_name" required="required" class="form-control" value="abhinav" placeholder="Contact person*">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" name="event_mobile" required="required" class="form-control" value="7728849872" placeholder="Contact phone number*">
												</div>
											</div>
										</div>
										<!--FILED END-->
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="email" name="event_email" required="required" class="form-control" value="vijay@gmail.com" placeholder="Contact Email Id *">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" name="event_website" class="form-control" value="" placeholder="Event Website">
												</div>
											</div>
										</div>
										<!--FILED END-->
	...
	<script type="text/javascript">
		var login_url = 'login?src=edit-event?code=48';
	</script>
