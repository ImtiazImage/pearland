				...
				<div class="login-main add-list">
					...
					<div class="log">
						<div class="login">
							...
							<form name="coupon_form" id="coupon_form" enctype="multipart/form-data" method="post" action="coupon_insert.html" class="listing_form_1">
								<!--FILED START-->
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" name="coupon_code" placeholder="Offer code" required>
										</div>
									</div>
								</div>
								<!--FILED END-->
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" name="coupon_link" placeholder="Website link(if online offer)">
										</div>
									</div>
								</div>
								<!--FILED END-->
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="file" required="required" name="coupon_photo" class="form-control" placeholder="Offer image">
										</div>
									</div>
								</div>
								<!--FILED END-->
...
<span class="btn-ser-need-ani">Help & Support</span>
	...
	<script type="text/javascript">
		var login_url ='login?src=add-coupons.html';
	</script>
