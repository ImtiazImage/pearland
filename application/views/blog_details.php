		...
		<div class="container">
			<div class="eve-deta-pg-main">
				<div class="lhs">
					...
					<div class="head"> <span class="dat"><?= date('M d',strtotime($blog->created_at));?></span>
					...
					<div class="list-rhs-form pglist-bg pglist-p-com">
						<div class="quote-pop">
							...
							<div id="event_detail_enq_fail" class="log" style="display: none;">
								...
								<?php
								if ($logged_id != NULL) { ?>
									<form method="post" action="<?= base_url('user/add-enquiry/'.'blog_details/'.$blog->blog_id);?>" name="detail_enquiry_form" id="detail_enquiry_form">
										...
										<input type="hidden" class="form-control" name="blog_id" value="<?=set_value('event_id',$blog->blog_id);?>" placeholder="" required>
										<input type="hidden" class="form-control" name="product_id" value="" placeholder="" required>
										<input type="hidden" class="form-control" name="receiving_user_id" value="<?=set_value('receiving_user_id',$blog->user_id);?>" placeholder="" required>
										...
										<input type="hidden" class="form-control" name="enquiry_source" value="<?=set_value('enquiry_source',$blog->blog_name);?>" placeholder="" required>
										<input type="hidden" class="form-control" name="enquiry_type" value="<?=set_value('enquiry_type','blog');?>" placeholder="" required>
