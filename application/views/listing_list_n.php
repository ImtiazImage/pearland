							...
							<div class="near-ser-list top-ser-secti-prov">
								<ul>
									<li>
										<div class="near-bx">
											<div class="ne-1">
												<img src="<?= base_url() ?>assets/images/services/1.jpg">
											</div>
											<div class="ne-2">
											...
											<a href="<?= base_url() ?>listing_details_n"></a>
										</div>
									</li>
									<li>
										<div class="near-bx">
											<div class="ne-1">
												<img src="<?= base_url() ?>assets/images/services/12.jpeg">
											</div>
											<div class="ne-2">
									...
									<li>
										<div class="near-bx">
											<div class="ne-1">
												<img src="<?= base_url() ?>assets/images/services/13.jpg">
											</div>
											<div class="ne-2">
									...
									<li>
										<div class="near-bx">
											<div class="ne-1">
												<img src="<?= base_url() ?>assets/images/services/14.jpg">
											</div>
											<div class="ne-2">
									...
									<li>
										<div class="near-bx">
											<div class="ne-1">
												<img src="<?= base_url() ?>assets/images/services/20.jpeg">
											</div>
											<div class="ne-2">
							...
							<li>
								<div class="eve-box">
									...
									<div class="al-img"> <span class="open-stat">open</span>
										<a href="<?= base_url() ?>listing_details_n">
									...
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Rolexo Villas in California</a>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div class="al-img"> <span class="open-stat">open</span>
										<a href="<?= base_url() ?>listing_details_n">
                                              <img src="<?= base_url() ?>assets/images/services/24.jpg" alt="">
                                          </a>
									</div>
									<!---END LISTING IMAGE--->
									<!---LISTING NAME--->
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Village food street</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div class="al-img"> <span class="open-stat">open</span>
										<a href="<?= base_url() ?>listing_details_n">
                                              <img src="<?= base_url() ?>assets/images/services/21.jpg" alt="">
                                          </a>
									</div>
									<!---END LISTING IMAGE--->
									<!---LISTING NAME--->
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Honey 2 massage & facial </a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Orange pet shops</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Ocean blue interier designs</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div class="al-img"> <span class="open-stat">open</span>
										<a href="<?= base_url() ?>listing_details_n">
                                              <img src="<?= base_url() ?>assets/images/services/30.jpg" alt="">
                                          </a>
									</div>
									<!---END LISTING IMAGE--->
									<!---LISTING NAME--->
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Packy hospital & Health care</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div class="al-img"> <span class="open-stat">open</span>
										<a href="<?= base_url() ?>listing_details_n">
                                              <img src="<?= base_url() ?>assets/images/services/22.jpeg" alt="">
                                          </a>
									</div>
									<!---END LISTING IMAGE--->
									<!---LISTING NAME--->
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Maching wedding matrimoney</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">The Royal Blue Resort & Hotels</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
                              ...
                              <li>
								<div class="eve-box">
									...
									<div>
										<h4>
                                              <a href="<?= base_url() ?>listing_details_n">Original bike services</a>
                                              <i class="li-veri"><img src="images/icon/svg/verified.png" alt=""></i>
                                          </h4>
										<label class="rat"> 
                                              <i class="material-icons">star</i>
