        ...
        <div class="container">
          <div class="row">
            <div class="login-main add-list add-ncate">
              ...
              <span class="udb-inst">Edit house Category</span>

              <div class="log log-1">

                <div class="login">

                  <h4>Edit This House Category</h4>
                  <?php echo form_open_multipart('admin/edit_house_category/'.$category->category_id,['class'=>'cre-dup-form cre-dup-form-show', 'id'=>'category_form']);?>
