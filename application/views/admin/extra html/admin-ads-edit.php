					...
					<div class="row">
						<div class="login-main add-list posr">
							...
							<div class="log log-1">
								<div class="login">
									<h4>Edit this Ad</h4>
									<form name="edit_ads_form" id="edit_ads_form" method="post" action="update_ads.html" enctype="multipart/form-data">
										...
										<ul>
											<li>
													...
													<div class="col-md-12">
														<div class="form-group">
															<select name="user_id" required="required" class="form-control" id="user_id">
																...
																<option selected value="37">Rn53 Themes</option>
													...
													<div class="col-md-12">
														<div class="form-group ca-sh-user">
															<select name="all_ads_price_id" required="required" class="form-control" id="adposi">
																...
																<option selected myTag="70" value="1">Home page Bottom (70$/per day)</option>
															...
															</select> <a href="../ad-details.html" class="frmtip" target="_blank">Pricing details</a>
														</div>
													</div>
												</div>
												<!--FILED END-->
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<input type="text" id="stdate" name="ad_start_date" value="2021-03-31" class="form-control" placeholder="Ad start date (MM/DD/YYYY)" required>
														</div>
													</div>
												</div>
												<!--FILED END-->
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<input type="text" id="endate" name="ad_end_date" value="2021-04-29" class="form-control" placeholder="Ad end date (MM/DD/YYYY)" required>
														</div>
													</div>
												</div>
												<!--FILED END-->
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea id="ad_link" name="ad_link" class="form-control" placeholder="Advertisement External link" required>https://bizbookdirectorytemplate.com/</textarea>
														</div>
													</div>
												</div>
												<!--FILED END-->
										...
										<div class="row">
											...
											<div class="col-md-12"> <a href="profile.html" class="skip">Go to User Dashboard >></a>
											</div>
										</div>
										<!--FILED END-->
									</form>
