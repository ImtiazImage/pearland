                ...
                <div class="ud-cen">
                    ...
                    <h2>Ad Pricing and other details</h2>
                        ...
                        <tbody>
                                ...
                                <td><a href="admin-ads-price-edit.html?row=1" class="db-list-edit">Edit</a></td>
                            </tr>
                                                        <tr>
                                <td>2</td>
                                ...
                                <td>50$</td>
                                <td><span class="db-list-rat">Active</span></td>
                                <td><a href="admin-ads-price-edit.html?row=2" class="db-list-edit">Edit</a></td>
                            </tr>
                                                        <tr>
                                <td>3</td>
                                ...
                                <td>20$</td>
                                <td><span class="db-list-rat">Active</span></td>
                                <td><a href="admin-ads-price-edit.html?row=3" class="db-list-edit">Edit</a></td>
                            </tr>
                                                        <tr>
                                <td>4</td>
                                ...
                                <td>70$</td>
                                <td><span class="db-list-rat">Active</span></td>
                                <td><a href="admin-ads-price-edit.html?row=4" class="db-list-edit">Edit</a></td>
                            </tr>
                                                        <tr>
                                <td>5</td>
                                ...
                                <td>20$</td>
                                <td><span class="db-list-rat">Active</span></td>
                                <td><a href="admin-ads-price-edit.html?row=5" class="db-list-edit">Edit</a></td>
                            </tr>
                                                        <tr>
                                <td>6</td>
                                ...
                                <td>40$</td>
                                <td><span class="db-list-rat">Active</span></td>
                                <td><a href="admin-ads-price-edit.html?row=6" class="db-list-edit">Edit</a></td>
                            </tr>
                            <!--                            <tr>-->
<!--                                <td>2</td>-->
