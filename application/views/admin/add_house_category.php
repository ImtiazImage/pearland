        ...
        <div class="container">
          <div class="row">
            <div class="login-main add-list add-ncate">
              ...
              <span class="udb-inst">New House Category</span>
              <div class="log log-1">
                <div class="login">
                  <h4>Add House Category</h4>
                  <form name="category_form" id="category_form" method="post" action="<?= base_url('admin/add_house_category') ?>" class="cre-dup-form cre-dup-form-show" enctype="multipart/form-data">
                    <ul>
                      <li>
                        <div class="row">
                          <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <a href="<?= base_url() ?>admin/all-house-category" class="skip">Go to All House Category >></a>
                  </div>
                </div>
              </div>
            </div>
