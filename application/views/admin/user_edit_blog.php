				...
				<div class="login-main add-list">
					...
					<div class="log">
						<div class="login add-list-off">
							...
							<form action="<?= base_url('admin/edit-blog/'.$blog->blog_id); ?>" class="blog_edit_form" id="blog_edit_form" name="blog_form" method="post" enctype="multipart/form-data">
								<ul>
									<li>
                                          <!--FILED START-->
                                          <div class="row">
                                            <div class="col-md-12">
                                              ...
                                              <select name="user_id" required="required" class="form-control" id="user_id">
                                                ...
                                                ?>
                                                <option value="<?= $user->user_id; ?>" <?= ($user->user_id == $blog->user_id)?'SELECTED':'';?> ><?= $user->name; ?></option>
