...
<section>
	<div class="ad-com">
		<div class="ad-dash leftpadd">
			<div class="login-reg">
				<div class="container">
					<form action="<?= base_url('admin/edit-house/'.$house->house_id); ?>" class="house_edit_form" id="house_edit_form" name="house_form" method="post" enctype="multipart/form-data">
						<div class="row">
													...
													<select name="user_id" required="required" class="form-control" id="user_id">
														...
														if($users){
															foreach($users as $user){
																?>
																<option value="<?= $user->user_id; ?>" <?= ($house->user_id == $user->user_id) ? 'SELECTED' : '';?> ><?= $user->name; ?></option>
															<?php } } ?>
														</select>                        
													</div>
												</div>
