        ...
        <div class="container">
          <div class="row">
            <div class="login-main add-list add-ncate">
              ...
              <span class="udb-inst">Edit Classifieds Category</span>

              <div class="log log-1">

                <div class="login">

                  <h4>Edit this classifieds Category</h4>
                  <?php echo form_open_multipart('admin/edit_classifieds_category/'.$category->category_id,['class'=>'cre-dup-form cre-dup-form-show', 'id'=>'category_form']);?>
