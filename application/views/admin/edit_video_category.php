        ...
        <div class="container">
          <div class="row">
            <div class="login-main add-list add-ncate">
              ...
              <span class="udb-inst">Edit Video Category</span>

              <div class="log log-1">

                <div class="login">

                  <h4>Edit this Video Category</h4>
                  <?php echo form_open_multipart('admin/edit_video_category/'.$category->category_id,['class'=>'cre-dup-form cre-dup-form-show', 'id'=>'category_form']);?>
                ...
                <div class="col-md-12">
                  <a href="<?= base_url() ?>admin/all-video-category" class="skip">Go to All Video Category >></a>
                </div>
                <div class="ud-notes">
