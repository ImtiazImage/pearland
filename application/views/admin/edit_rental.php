...
<section>
	<div class="ad-com">
		<div class="ad-dash leftpadd">
			<div class="login-reg">
				<div class="container">
					<form action="<?= base_url('admin/edit-rental/'.$rental->rental_id); ?>" class="rental_edit_form" id="rental_edit_form" name="rental_form" method="post" enctype="multipart/form-data">
						<div class="row">
