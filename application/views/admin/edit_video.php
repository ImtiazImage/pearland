			...
			<div class="login-main add-list">
				...
				<div class="log">
					<div class="login add-list-off">
						...
						<?php } ?>		
						<form action="<?= base_url('admin/edit-video/'.$video->video_id); ?>" class="video_edit_form" id="video_edit_form" name="video_form" method="post" enctype="multipart/form-data">
												...
												<select name="user_id" required="required" class="form-control" id="user_id">
													...
													if($users){
														foreach($users as $user){
															?>
															<option value="<?= $user->user_id; ?>" <?= ($video->user_id == $user->user_id) ? 'SELECTED' : '';?> ><?= $user->name; ?></option>
														<?php } } ?>
													</select>      
												</div>
											</div>
