...
<section>
  <div class="ad-com">
    <div class="ad-dash leftpadd">
      <div class="login-reg">
        <div class="container">
          <form action="<?= base_url('admin/add_product');?>" class="product_form" id="product_form" name="product_form"
                ...
                <div class="login">
					<ul>
                   	...
                   	<div class="row">
	                    ...
	                    <div class="col-md-12">
	                      <a href="<?= base_url('admin/products');?>" class="skip">Go to User Dashboard >></a>
	                    </div>
	                </div>
            	</div>
              </div>
