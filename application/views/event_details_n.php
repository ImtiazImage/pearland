	...
	<section class=" eve-deta-body">
		<div class="container">
			...
			<div class="pro-bot-shar">
				...
				<ul>
					<li>
						<div class="sh-pro-shar sh-pro-face"> <a target="_blank" href="">Facebook</a>
						</div>
					</li>
					<li>
						<div class="sh-pro-shar sh-pro-twi"> <a target="_blank" href="">Twitter</a>
						</div>
					</li>
					<li>
						<div class="sh-pro-shar sh-pro-what"> <a target="_blank" href="">WhatsApp</a>
						</div>
					</li>
					<li>
						<div class="sh-pro-shar sh-pro-link"> <a target="_blank" href="">Linkedin</a>
						</div>
					</li>
					<li>
						<div style="background-color: #da271a" class="sh-pro-shar sh-pro-pin"> <a target="_blank" href="">Pinterest</a>
						</div>
					</li>
				</ul>
			</div>
						...
						<ul>
									<li>
										<div class="pro-eve-box">
											<div>
												<img src="<?= base_url() ?>assets/images/blogs/blog5.jpg">
											</div>
											<div> <span>18                                                        <b>Mar</b></span>
												<h2>Surfing Competition Hawaii</h2>
												<p>4754 Grove Avenue, Hawaii</p>
											</div> <a href="<?= base_url() ?>event_details_n" class="fclick">&nbsp;</a>
										</div>
									</li>
									<li>
										<div class="pro-eve-box">
											<div>
												<img src="<?= base_url() ?>assets/images/services/10.jpg">
											</div>
									...
									<li>
										<div class="pro-eve-box">
											<div>
												<img src="<?= base_url() ?>assets/images/services/11.jpg">
											</div>
											<div> <span>18                                                        <b>Jan</b></span>
