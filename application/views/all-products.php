						...
						<div class="all-filt"> <span class="fil-mob-clo"><i class="material-icons">close</i></span>
							...
							<div class="filt-com lhs-cate">
								...
								<div class="dropdown">
									...
									<!--                                    -->
									<!--                                </ul>-->
									<select onChange="ProductSubcategoryFilter(this.value);" class="cat_check" name="cat_check" id="cat_check" class="chosen-select ">
						...
						<div class="all-list-sh all-product-total">
							<ul>
								...
								<li>
									...
									?>
											<img src="<?= base_url($images[0]);(empty($value->profile_image)) ? base_url('assets/images/no_photo.jpg') :  base_url($value->profile_image)?>">
										</div>
										<div class="all-pro-txt">
											<h4><?= $product->product_name; ?></h4>
											<span class="pri"><b class="pro-off"><?= $product->product_price; ?></b><?= (!empty($product->product_price_offer)) ?  $product->product_price_offer."%off" : ''?> </span>
											<div class="links"> <a href="#" data-toggle="modal" data-target="#quote">Get quote</a>
											</div>
										</div>
										<a href="<?= base_url('user/product-details/'.$product->product_id);?>" class="pro-view-full"></a>
									</div>
								</li>
							<?php } } ?>
							</ul>
