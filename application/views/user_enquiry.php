		...
		<table class="responsive-table bordered">
			...
			<tbody>
				<tr>
					...
					<td><a href="enquiry_trash.html?messageenquirymessageenquirymessageenquirymessageenquiry=229" class="db-list-edit">Delete</a>
					</td>
				</tr>
				<tr>
					<td>2</td>
					<td>Loki <span>07, Feb 2021</span>
					</td>
					<td>thedirectoryfinder@gmail.com</td>
					<td>87654567</td>
					<td>Hi Team, please send the pricing details for the 1 day function</td>
					<td>Titan Wedding Hall</td>
					<td>Website</td>
					<td>listing-details?src=Website&&code=LIST381</td>
					<td><a href="enquiry_trash.html?messageenquirymessageenquirymessageenquirymessageenquiry=223" class="db-list-edit">Delete</a>
					</td>
				</tr>
				<tr>
					<td>3</td>
