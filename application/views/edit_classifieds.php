			...
			<div class="login-main add-list">
				...
				<div class="log">
					<div class="login add-list-off">
						...
						<?php } ?>		
						<form action="<?= base_url('user/edit-classifieds/'.$classifieds->classifieds_id); ?>" class="classifieds_edit_form" id="classifieds_edit_form" name="classifieds_form" method="post" enctype="multipart/form-data">
